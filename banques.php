<?php
    ...
    curl_setopt($ch, CURLOPT_POSTFIELDS, '{"collection":"banques","database":"online_payment","dataSource":"Cluster0"}');
                                ...
                                <table id="datatablesSimple">
                                    ...
                                    <tbody>
                                      ...
                                      foreach ($resultJson->{'documents'} as $item) {
                                        ?>
                                        <tr>
                                            <td><?php echo $item->{'Code_banque'} ?></td>
                                            <td><?php echo $item->{'Nom_banque'} ?></td>
