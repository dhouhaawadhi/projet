<?php
    ...
    curl_setopt($ch, CURLOPT_POSTFIELDS, '{"collection":"compte","database":"online_payment","dataSource":"Cluster0"}');
                                    ...
                                    <tbody>
                                      ...
                                      foreach ($resultJson->{'documents'} as $item) {
                                        ...
                                        <tr>
                                            ...
                                            <td><?php echo $item->{'RIB'} ?></td>
                                            <td><?php echo $item->{'IBN'} ?></td>
                                            <td><?php echo $item->{'Type_Compte'} ?></td>
                                        </tr>
                                        <?php
                                            }
                                        curl_close($ch);
